...
struct LineView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            LineView(data: [8,23,54,32,12,37,7,23,43], title: "Full chart", legend: "Tesst", style: Styles.lineChartStyleOne, initialY: 0, showBackground: true, customBackground: LinearGradient(gradient: Gradient(colors: [Colors.color1Accent, .white]), startPoint: .bottom, endPoint: .top))
